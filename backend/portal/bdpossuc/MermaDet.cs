...
public partial class MermaDet
{
    ...
    public virtual Merma Merma { get; set; } = null!;

    public virtual ICollection<MermaDetSerie> MermaDetSeries { get; set; } = new List<MermaDetSerie>();
}
